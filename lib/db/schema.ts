...
// Better Auth tables (main auth system)
...
// Application tables (updated to use better-auth user IDs)
...
export const teamMembers = pgTable('team_members', {
  ...
  userId: text('user_id')
    .notNull()
    .references(() => user.id), // Now references better-auth user table
...
export const activityLogs = pgTable('activity_logs', {
  ...
  teamId: integer('team_id')
    .notNull()
    .references(() => teams.id),
  userId: text('user_id').references(() => user.id), // Now references better-auth user table
